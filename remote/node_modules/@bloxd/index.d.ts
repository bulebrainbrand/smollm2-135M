 ...
 * Pass \`/*@__KEY__*/"default"\` for the default variation.
 *
 * @param playerId The player to matchmake
 * @param varname Sub-variation name (\`[A-Za-z0-9_-]\`, 1-32 chars), or \`/*@__KEY__*/"default"\`
 */
matchmakeToVariation(playerId: PlayerId, varname: string): void
/**
 * Get the current sub-variation name.
 * Returns \`/*@__KEY__*/"default"\` when there is no named sub-variation.
 */
getVariation(): string
/**
...
export type GunshotOrigin = /*@__KEY__*/"default" | "head"
...
export type ShopItemUserInput =
	| { type: /*@__KEY__*/"text"; placeholderText?: string; wordCharsOnly?: boolean; initialValue?: string } // wordCharsOnly defaults to false. If true, only allows \w character (alphanumeric and _). initialValue always takes precedence as the text input value when set.
...
export type RecursiveReadonly<T> = T extends Primitive
	...
	: T extends (...args: never[]) => unknown
		...
		: T extends readonly unknown[]
			? number extends T[/*@__KEY__*/"length"]
...
export type InclusiveRange<N extends number, Arr extends number[] = []> = Arr[/*@__KEY__*/"length"] extends N
	? Arr[number] | Arr[/*@__KEY__*/"length"]
	: InclusiveRange<N, [...Arr, Arr[/*@__KEY__*/"length"]]>
...
export type DefaultPhysicsTypeSettings = Readonly<{
	...
	/**
	 * Caps how fast it falls while flying. Only used when \`airborneMovement\` is \`/*@__KEY__*/"heading"\`.
...
export type HeadingAirborneMovement = Readonly<{ model: /*@__KEY__*/"heading" }>
...
export interface _TypeOf {
	...
	customItemStats: readonly ["ttb", "displayName", "harvestLevel", "stoodOnSpeedMultiplier", "specialToolDrop", "specialToolBonusDrops", /*@__KEY__*/"description", "altActionable", "eatHealAmt", "eatShieldAmt", "damage", "attackRange", "attackCooldownMs", "secondaryDamage", "absorbThrowable", "armourReduction", "CrosshairText", "gunStats", "showInCreativeInven"]
	...
	cosmeticTypes: readonly ["skin", "hat", "head", "eyebrows", "eyes", "back", /*@__KEY__*/"body", "legs", "shoes", "cape", "nameColour", "profileEffect", "emote"]
	playerPoses: readonly ["standing", "sitting", "zombie", "gliding", "driving", "sleeping", "riding"]
	mobVariations: { readonly Pig: readonly [/*@__KEY__*/"default"]; readonly Cow: readonly [/*@__KEY__*/"default", "cream"]; readonly Sheep: readonly [/*@__KEY__*/"default", "black", "red", "orange", "pink", "purple", "yellow", "blue", "brown", "cyan", "gray", "green", "lightBlue", "lightGray", "lime", "magenta"]; readonly Horse: readonly [/*@__KEY__*/"default", "black", "brown", "cream"]; readonly Slime: readonly [/*@__KEY__*/"default"]; readonly "Cave Golem": readonly [/*@__KEY__*/"default", "iron", "corrupted"]; readonly "Draugr Zombie": readonly [/*@__KEY__*/"default", "longHairChestplate", "longHairClothed", "shortHairClothed", "flower", "flower2", "mushroom", "vine", "vine2", "corrupted", "corrupted2"]; readonly "Draugr Skeleton": readonly [/*@__KEY__*/"default"]; readonly "Frost Golem": readonly [/*@__KEY__*/"default"]; readonly "Frost Zombie": readonly [/*@__KEY__*/"default", "longHairChestplate", "shortHairClothed"]; readonly "Frost Skeleton": readonly [/*@__KEY__*/"default"]; readonly "Draugr Knight": readonly [/*@__KEY__*/"default"]; readonly Wolf: readonly [/*@__KEY__*/"default", "white", "brown", "grey", "spectral"]; readonly Bear: readonly [/*@__KEY__*/"default"]; readonly Deer: readonly [/*@__KEY__*/"default"]; readonly Stag: readonly [/*@__KEY__*/"default"]; readonly "Gold Watermelon Stag": readonly [/*@__KEY__*/"default"]; readonly Gorilla: readonly [/*@__KEY__*/"default"]; readonly Wildcat: readonly [/*@__KEY__*/"default", "tabby", "grey", "black", "calico", "siamese", "leopard"]; readonly "Magma Golem": readonly [/*@__KEY__*/"default"]; readonly "Draugr Huntress": readonly [/*@__KEY__*/"default", "chainmail"]; readonly "Spirit Golem": readonly [/*@__KEY__*/"default"]; readonly "Spirit Wolf": readonly [/*@__KEY__*/"default"]; readonly "Spirit Bear": readonly [/*@__KEY__*/"default"]; readonly "Spirit Stag": readonly [/*@__KEY__*/"default"]; readonly "Spirit Gorilla": readonly [/*@__KEY__*/"default"]; readonly "Draugr Warper": readonly [/*@__KEY__*/"default"]; readonly "Frost Wraith": readonly [/*@__KEY__*/"default"]; readonly "Draugr Reaver": readonly [/*@__KEY__*/"default"]; readonly Stalker: readonly [/*@__KEY__*/"default", "crimson", "frost", "void"]; readonly Crone: readonly [/*@__KEY__*/"default"]; readonly "Iron Guardian": readonly [/*@__KEY__*/"default"]; readonly "Gold Guardian": readonly [/*@__KEY__*/"default"]; readonly "Diamond Guardian": readonly [/*@__KEY__*/"default"]; readonly "Moonstone Guardian": readonly [/*@__KEY__*/"default"]; readonly NPC: readonly [/*@__KEY__*/"default", "emma", "leo", "isabel", "sanjay", "imara", "enoch", "sara", "carmen"]; readonly "67": readonly [/*@__KEY__*/"default"]; readonly "Bobino Musculino": readonly [/*@__KEY__*/"default"]; readonly "Capitano Explovissimo": readonly [/*@__KEY__*/"default"]; }
...
export type ClientOptions = {
		...
		/** Where gunshots originate from. /*@__KEY__*/"default" preserves camera-assisted behavior. */
...
export type OtherEntitySettings = {
		...
		nameColour: /*@__KEY__*/"default" | "yellow" | "lime" | "green" | "aqua" | "cyan" | "blue" | "purple" | "pink" | "red" | "orange"
	}
